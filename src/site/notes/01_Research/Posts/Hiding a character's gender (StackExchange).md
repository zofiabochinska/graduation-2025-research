---
{"dg-publish":true,"permalink":"/01-research/posts/hiding-a-character-s-gender-stack-exchange/","dg-note-properties":{"date created":"Monday, March 3rd 2025","date modified":"Tuesday, March 24th 2026"}}
---

https://writing.stackexchange.com/questions/27723/how-do-i-keep-the-gender-of-my-main-character-purposely-ambiguous 
### 2025-03-03 17:41
...
Someone's response to the "scheme" of not revealing a character's gender in a story (and a proposed solution):

> One of the things that seems like a good idea to many beginning writers is trying to deceive the reader in some way or another. There is one problem with this idea: readers don't like it. 
> 
...
However, I don't think this necessarily applies to a visual novel in which the MC is the player - since in other VNs I played it didn't matter to the story - the MC *is* the player (to an extent of course). So, while interesting if I wanted to write a novel, I think this reveal could work in my VN, since the readers won't expect me to reveal the gender if their character. 

Moreover, I am not sure if I am even going to introduce this "scheme" to my story, as it maybe doesn't feel as powerful as other reveals and parts of it that I planned.
## References

[[01_Research/Podcasts/Essential Guide to Writing a Novel (James Thyer)\|Essential Guide to Writing a Novel (James Thyer)]]

[[01_Research/Tools/In-Depth pronouns (Ren'py)\|In-Depth pronouns (Ren'py)]]
